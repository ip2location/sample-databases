# IP2Location DB26 – IP Geolocation Database

## IP-Country-Region-City-Latitude-Longitude-ZIPCode-TimeZone-ISP-Domain-NetSpeed-AreaCode-Weather-Mobile-Elevation-UsageType-AddressType-Category-District-ASN Database Sample

[IP2Location DB26 database](https://www.ip2location.com/database/db26-ip-country-region-city-latitude-longitude-zipcode-timezone-isp-domain-netspeed-areacode-weather-mobile-elevation-usagetype-addresstype-category-district-asn) provides an IP geolocation solution to determine the country, region or state, district, city, latitude and longitude, ZIP/Postal code, time zone, Internet Service Provider (ISP) or company name, domain name, net speed, area code, weather station code, weather station name, mobile country code (MCC), mobile network code (MNC) and carrier brand, elevation, usage type, address type, IAB category and ASN of IP address.

This repository offers a sample version of the IP2Location DB26 database in CSV, BIN, and CIDR formats. The sample includes a limited number of data rows and is intended solely for evaluation and testing—not for production use. For full, high‑accuracy data with daily updates, please subscribe to the commercial IP2Location DB26 database. 
...
| category               | VARCHAR(10)                   | The domain category based on IAB Tech Lab Content Taxonomy. Includes Tier-1 and Tier-2 (if available) level categories widely used in advertising, Internet security, and filtering appliances. |
...
| **CIDR**     | [Download Sample](https://github.com/ip2location/sample-databases/tree/main/IP2Location/DB26/ip2location-db26-sample.ipv4.cidr.csv) | [Download Sample](https://github.com/ip2location/sample-databases/tree/main/IP2Location/DB26/ip2location-db26-sample.ipv6.cidr.csv) |
